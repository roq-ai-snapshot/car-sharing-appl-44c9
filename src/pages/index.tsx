  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the freedom of mobility with Car Sharing Application, your reliable partner for convenient, sustainable, and affordable travel."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the freedom of mobility with Car Sharing Application, your reliable partner for convenient, sustainable, and affordable travel.`}
            </Text>
            <Box
